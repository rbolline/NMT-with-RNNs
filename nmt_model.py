...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.h_projection = nn.Linear(2*self.hidden_size, self.hidden_size, bias=False)#possibly wrong
        self.c_projection = nn.Linear(2*self.hidden_size, self.hidden_size, bias=False)#possibly wrongc
